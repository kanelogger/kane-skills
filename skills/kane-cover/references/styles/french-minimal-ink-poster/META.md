...
source: references/styles/french-minimal-ink-poster/STYLE.md
style_anchors:
...
用法式编辑海报的克制排版、大片留白和手绘墨线，把文章主题压缩成一个准确的视觉隐喻。重点不是画全主题，而是先理解核心观点、矛盾、情绪和因果，再选择人物、物体、结构、距离、遮挡或轻微数字痕迹作为唯一视觉中心。该 style 只负责墨线极简海报的视觉语言；平台适配、长文提炼和通用封面结构由 `kane-cover` 负责。
