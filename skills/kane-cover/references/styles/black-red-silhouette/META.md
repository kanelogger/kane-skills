...
source: references/styles/black-red-silhouette/STYLE.md
style_anchors:
...
黑红剪影是一种高冲击、低信息噪声的极简封面风格。画面像一块巨大的红色舞台屏幕，主体以黑色图形剪影出现，白色只用于标题、少量高光和关键点睛。该 style 只负责三色剪影视觉、主体优先的图文关系和直接隐喻；平台适配、长文提炼和通用封面约束由 `kane-cover` 负责。
