...
source: references/styles/research-journal-concept/STYLE.md
style_anchors:
...
科研期刊封面式概念视觉，强调机制、材料、医学、生物、工程和实验室语境。用专业但可传播的科学隐喻组织画面。该 style 只负责科研期刊封面气质、科学主体和机制暗示；平台适配、长文提炼和通用封面约束由 `kane-cover` 负责。
