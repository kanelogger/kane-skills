...
source: references/styles/brand-collaboration-connection/STYLE.md
style_anchors:
...
品牌协同连接是一种用于表达两个品牌、工具或产品互相连接的极简横版封面风格。它把两个输入 Logo 转译成左右两枚高级轻拟物 3D 圆角图标，用一条丝滑渐变连接线和中心节点表现协同、集成、自动化或工作流打通。该 style 只负责双品牌连接的视觉语言、图标质感、色彩关系和横版构图；平台适配、长文提炼和通用封面约束由 `kane-cover` 负责。
