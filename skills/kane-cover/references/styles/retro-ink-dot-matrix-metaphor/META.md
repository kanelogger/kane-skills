...
source: references/styles/retro-ink-dot-matrix-metaphor/STYLE.md
style_anchors:
...
复古油墨机械打印与极简点阵隐喻结合的封面海报。核心不是炫技插画，而是稳定的旧式打印版式、固定色彩、固定字体和一个小而明确的黑色点阵主体。该 style 只负责复古油墨点阵视觉、固定构图和信息克制；平台适配、长文提炼和通用封面约束由 `kane-cover` 负责。
