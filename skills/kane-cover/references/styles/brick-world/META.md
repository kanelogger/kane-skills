...
source: references/styles/brick-world/STYLE.md
style_anchors:
...
用积木、模块、搭建和玩具世界表达系统、团队、计划、教育与成长。整体更偏明快、亲和和可组合结构隐喻。该 style 只负责积木材质、微缩棚拍和搭建隐喻；平台适配、长文提炼和通用封面约束由 `kane-cover` 负责。
