...
source: references/styles/giant-perspective-chinese-title/STYLE.md
style_anchors:
...
以超大中文标题和强透视空间作为第一视觉，制造速度、压迫、冲突和事件海报感。适合中文标题主导的高冲击封面。该 style 只负责巨型中文标题、透视空间和冲击构图；平台适配、长文提炼和通用封面约束由 `kane-cover` 负责。
