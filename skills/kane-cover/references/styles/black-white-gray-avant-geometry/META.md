...
source: references/styles/black-white-gray-avant-geometry/STYLE.md
style_anchors:
...
黑白灰先锋海报、随机字体排版、随机几何母题和现代主义构成。强调克制、动态、实验性和少量强调色。该 style 只负责黑白灰先锋几何语言、随机版式和几何母题；平台适配、长文提炼和通用封面约束由 `kane-cover` 负责。
