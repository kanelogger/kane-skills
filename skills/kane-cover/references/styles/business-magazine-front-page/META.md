...
source: references/styles/business-magazine-front-page/STYLE.md
style_anchors:
...
商业科技杂志头版式封面。强调锐利标题、编辑栏、主视觉人物或概念物、趋势报道感和高级商业传播气质。该 style 只负责商业杂志头版结构、媒体感和商业隐喻；平台适配、长文提炼和通用封面约束由 `kane-cover` 负责。
